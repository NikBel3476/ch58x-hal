...
use super::ffi::{self, bStatus_t, gattCharCfg_t, gattServiceCBs_t};
use super::gatt::GattAttribute;
use crate::ble::ffi::attAttribute_t;
...
impl GATTServApp {
    ...
    pub fn register_service(
        attrs: &'static mut [attAttribute_t],
        enc_key_size: u8,
        service_cbs: &'static mut gattServiceCBs_t,
    ) -> bStatus_t {
    ...
    #[inline]
    pub unsafe fn deregister_service(handle: u16, p2pAttrs: *mut *mut attAttribute_t) -> bStatus_t {
        unsafe { ffi::GATTServApp_DeregisterService(handle, p2pAttrs) }
    }

    #[inline]
    pub unsafe fn init_char_cfg(connHandle: u16, charCfgTbl: *mut gattCharCfg_t) {
        unsafe { ffi::GATTServApp_InitCharCfg(connHandle, charCfgTbl) }
    }

    #[inline]
    pub unsafe fn send_service_changed_ind(connHandle: u16, taskId: u8) -> bStatus_t {
        unsafe { ffi::GATTServApp_SendServiceChangedInd(connHandle, taskId) }
    }

    #[inline]
    pub unsafe fn read_char_cfg(connHandle: u16, charCfgTbl: *mut gattCharCfg_t) -> u16 {
        unsafe { ffi::GATTServApp_ReadCharCfg(connHandle, charCfgTbl) }
    }

    #[inline]
    pub unsafe fn write_char_cfg(connHandle: u16, charCfgTbl: *mut gattCharCfg_t, value: u16) -> u8 {
    ...
    #[inline]
    pub unsafe fn process_ccc_write_req(
        connHandle: u16,
        pAttr: *mut attAttribute_t,
        pValue: *mut u8,
        len: u16,
        offset: u16,
        validCfg: u16,
